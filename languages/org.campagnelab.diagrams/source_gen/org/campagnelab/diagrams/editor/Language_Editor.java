...
public class Language_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_75gu8q_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_75gu8q_b0(editorContext, node));
  ...
  private EditorCell createConstant_75gu8q_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "-");
    editorCell.setCellId("Constant_75gu8q_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }

  private EditorCell createProperty_75gu8q_c0(EditorContext editorContext, SNode node) {
