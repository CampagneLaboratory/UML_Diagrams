...
public class ConceptReference_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_s9fwl0_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefCell_s9fwl0_b0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefCell_s9fwl0_b0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("concept");
    provider.setNoTargetText("<no concept>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new ConceptReference_Editor._Inline_s9fwl0_a1a());
  ...
  public static class _Inline_s9fwl0_a1a extends InlineCellProvider {
    public _Inline_s9fwl0_a1a() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_s9fwl0_a0b0(editorContext, node);
    }

    private EditorCell createProperty_s9fwl0_a0b0(EditorContext editorContext, SNode node) {
